...
def parse_options():
    ...
    parser.add_option('-k', '--kmer-length',
            ...
            help='the value of k for kmers')
    parser.add_option('-e', '--handle-errors',
            dest='handle_errors', action='store_true',
            help='compensates for errors if this flag is on')
    parser.add_option('-p', '--plot-histogram',
            dest='create_histogram', action='store_true',
            help='will create an png image of the kmer frequencies if this flag is on. The system must have matplotlib installed to be able to use this flag')
